...
class ImageFrame(tk.Frame):
    def __init__(self, master,file="",parentBackground="black",**kwargs) -> None:
        if file:
            self.image=Image.open(file)
        self.master=master
        self.parentBackground=parentBackground
    ...
    def grid(self,**kwargs):
        if not (self.imageLabel):
            self.imageLabel = tk.Label(self,bd=0,relief="sunken")
...
class Main():
    ...
    def drawBottomBar(self):
        self.bottombar = tk.Frame(self.scene, bg="#3d3d3d", bd=0)
        ...
        accordionTitles = tk.Frame(self.bottombar, bg="#3d3d3d", bd=0)
        accordionTitles.grid(row=0, column=0, sticky="nesw")
        accordionTitles.grid_rowconfigure(0, weight=1)
        accordionTitles.grid_columnconfigure(0, weight=90,uniform="row")
        accordionTitles.grid_columnconfigure(2, weight=90,uniform="row")
        accordionTitles.grid_columnconfigure(4, weight=90,uniform="row")
        accordionTitles.grid_columnconfigure(6, weight=90,uniform="row")
        accordionTitles.grid_columnconfigure(8, weight=90,uniform="row")
        basicTabButton = ImageButton(accordionTitles, file=f"{self.dirPath}\Assets\Buttons\\ButtonBasics.png", bg="#3d3d3d", command=lambda: self.updateBottomTabs("basic"),bd=0,activebackground="#3d3d3d")
        basicTabButton.grid(row=0, column=0, sticky="nesw")
        timeTabButton = ImageButton(accordionTitles, file=f"{self.dirPath}\Assets\Buttons\\ButtonTime.png", bg="#3d3d3d", command=lambda: self.updateBottomTabs("time"),bd=0,activebackground="#3d3d3d")
        timeTabButton.grid(row=0, column=2, sticky="nesw")
        levelsTabButton = ImageButton(accordionTitles, file=f"{self.dirPath}\Assets\Buttons\\ButtonLevels.png", bg="#3d3d3d", command=lambda: self.updateBottomTabs("level"),bd=0,activebackground="#3d3d3d")
        levelsTabButton.grid(row=0, column=4, sticky="nesw")
        trimTabButton = ImageButton(accordionTitles, file=f"{self.dirPath}\Assets\Buttons\\ButtonTrim.png", bg="#3d3d3d", command=lambda: self.updateBottomTabs("trim"),bd=0,activebackground="#3d3d3d")
        trimTabButton.grid(row=0, column=6, sticky="nesw")
        effectsTabButton = ImageButton(accordionTitles, file=f"{self.dirPath}\Assets\Buttons\\ButtonEffects.png", bg="#3d3d3d", command=lambda: self.updateBottomTabs("effects"),bd=0,activebackground="#3d3d3d")
        effectsTabButton.grid(row=0, column=8, sticky="nesw")
        ...
        self.bottomBarBasicTab.grid_rowconfigure(5, weight=1, uniform='row')

        numberLabel = tk.Label(self.bottomBarBasicTab,text="Number:", background="#2d2c2c", fg="white")
        numberLabel.grid(row=1, column=1, sticky="nswe")
        durationLabel = tk.Label(self.bottomBarBasicTab, text="Duration:", background="#2d2c2c", fg="white")
        durationLabel.grid(row=2, column=1, sticky="nswe")
        prewaitLabel = tk.Label(self.bottomBarBasicTab, text="Prewait:", background="#2d2c2c", fg="white")
        prewaitLabel.grid(row=3, column=1, sticky="nswe")
        autoplayLabel = tk.Label(self.bottomBarBasicTab, text="Continue:", background="#2d2c2c", fg="white")
        autoplayLabel.grid(row=4, column=1, sticky="nswe")
        var = tk.StringVar()
        self.numberInput = tk.Entry(self.bottomBarBasicTab, textvariable=var, bg="#2d2c2c", fg="white")
        var.trace("w", lambda name, index, mode, var=var: self.cueValueChange("number"))
        self.numberInput.grid(row=1, column=2, sticky="we")
        var = tk.StringVar()
        self.durationInput = tk.Entry(self.bottomBarBasicTab,textvariable=var, disabledbackground="#2d2c2c",readonlybackground="#2d2c2c",background="#2d2c2c", fg="white")
        var.trace("w", lambda name, index, mode, var=var: self.cueValueChange("duration"))
        self.durationInput.grid(row=2, column=2, sticky="we")
        var = tk.StringVar()
        self.prewaitInput = tk.Entry(self.bottomBarBasicTab, textvariable=var, bg="#2d2c2c", fg="white")
        var.trace("w", lambda name, index, mode, var=var: self.cueValueChange("prewait"))
        self.prewaitInput.grid(row=3, column=2, sticky="we")
        ...
        self.qtitle2 = tk.Entry(self.bottomBarBasicTab, textvariable=var, font=(40), bg="#2d2c2c", fg="White")
        self.qtitle2.grid(row=1, column=3, sticky="ew", padx=10)
        notes = tk.Text(self.bottomBarBasicTab, font=(40), bg="#2d2c2c", width=1, height=1, fg="white")
        notes.grid(row=2, column=3, sticky="nesw", rowspan=2, padx=10, pady=20)
        self.fileInput = tk.Button(self.bottomBarBasicTab, font=(f'{self.globFont} 10'), bg="#2d2c2c", width=1,height=1, fg="white", text="Select Path", command=self.selectPath)
        ...
        self.bottomBarEffectsTab = ImageFrame(self.bottombar, parentBackground="#3d3d3d",file=f"{self.dirPath}\Assets\Buttons\\EffectsCanvas.png",bd=0)
