...
class Main():
    ...
    def createNewCue(self, cueNumber=0, name="New Cue", prewait=0.0, time=0.0, autoplay="None") -> None:
        ...
        q = Cue(cueNumber=cueNumber, name=name,
                prewait=prewait, time=time, autoplay=autoplay)
    ...
    def drawTopbar(self):
        ...
        goButton = tk.Button(button_border, text="GO", bg="gray",
                             bd=0, font=("Bold", 30), command=self.play)
        ...
        topInfoFrame = tk.Frame(
            self.topbar, bg="#3d3d3d", highlightcolor="white")
        ...
        self.qtitle = tk.Entry(
            topInfoFrame, textvariable=var, font=(30), bg="gray")
    ...
    def drawBottomBar(self):
        ...
        accordionTitles = tk.Frame(
            self.bottombar, bg="#313131", highlightcolor="white", bd=1)
        ...
        autoplayInput = tk.OptionMenu(
            self.bottomBarBasicTab, self.autoplayInputVar, *["None", "Follow"])
